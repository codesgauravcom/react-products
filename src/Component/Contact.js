    ...
    <form action="/">
      ...
      <fieldset>
        ...
        <div  class="terms-mailing">
          <div class="checkbox">
            <input type="checkbox" name="checkbox"/><span>I accept the Privacy Policy for Gk brand</span>
          </div>
          <div class="checkbox">
      ...
      <button className="newbut" type="submit" href="/">Submit</button>
    </form>
    </div> 
  </body>
